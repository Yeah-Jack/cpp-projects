...
void menu(short &auswahl);
void berechnung(short &auswahl, double &widerstand1, double &widerstand2,
...
void menu(short &auswahl) {
  std::cout << "Menü:\n"
            << "1) Parallelschaltung von 2 Widerständen\n"
            << "2) Reihenschaltung von 2 Widerständen\n"
